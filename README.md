...
- Could you explain how the head class constructor works? We understand that el is the board and this.node is the head but we're struggling to understand how and why that's the case. 
- How do we acccess properties in styles.css from class JS file?